...
alchemy::App::create(alchemy::cli::ParsedOptions options)
{
  try
  {
    alchemy::logger::debug(
        "alchemy::App::create: rootDir={}, buildDir={}, outputDir={}, "
        "salign={}, dryRun={}, jobs={}\n",
        options.rootDir.string(),
        options.buildDir.string(),
        options.outputDir.string(),
        options.enableSalign,
        options.enableDryRun,
        options.jobs);
    ...
    alchemy::logger::info("alchemy::{}discovery{}::finding sources...\n",
...
alchemy::App::exec()
{
  ...
  {
    alchemy::logger::warn("alchemy::{}no source files to process{}\n",
  ...
  try
  {
    ...
    alchemy::logger::debug(
        "alchemy::App::exec: discovery -> parser: {} source file(s), "
        "buildDir={}\n",
        alchemy::App::context().inventory.sourceFiles.size(),
        alchemy::App::context().cliArgs.buildDir.string());
    ...
    alchemy::core::Result<std::unique_ptr<alchemy::parser::ClangParser>>
        clangResult = alchemy::parser::ClangParser::create(
            ...
            alchemy::App::context().cliArgs.excludePatterns);
    ...
    alchemy::logger::debug(
        "alchemy::App::exec: parser -> pipeline: compiler={}, "
        "{} operation(s) [salign={}]\n",
        parser->getName(),
        Operations.size(),
        alchemy::App::context().cliArgs.enableSalign);
